...
const Goals = props => {
  ...
  const saveGoalData = () => {
    ...
    axios
      .post(
        'http://beingdiligent.tk:8080/goal/create',
        {
  ...
  const modifygoalFn = () => {
    ...
    axios
      .put(
        'http://beingdiligent.tk:8080/goal/update',
        {
          goalId: id,
          date: chooseTimeString,
          title: goalTextInput,
        ...
        <View style={styles.modalContainer}>
          <View style={styles.closeContainer}>
            <TouchableOpacity
              ...
              <Image source={closeIcon} style={styles.closeStyle} />
            </TouchableOpacity>
          </View>
          <View style={{flex: 2}}>
          ...
          <View style={{flex: 1, flexDirection: 'row'}}>
            <TouchableOpacity
              ...
              <Text style={{color: 'black'}}>목표 설정하기</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.submitNclose}
              onPress={() => {
